...
def build():
    ...
    respaldo = [
        ...
        ("7", "Carta o invitacion relacionada a ICLEI / Semana del Clima",
         "Cualquier comunicacion oficial que respalde el motivo institucional del viaje."),
        ("8", "3 ultimos roles de pago",
         "Con sello y firma fisica de AME."),
        ("9", "Reserva de vuelos y hospedaje",
         "Itinerario confirmado del 18 al 28 de septiembre, hospedaje en Washington Heights."),
        ("10", "Copia del acta de matrimonio",
