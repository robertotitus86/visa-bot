"""
Genera pdf-paola-samaniego-guia-uso.pdf -- Como usar el simulador (instrucciones de navegacion)
...
SIMULADOR_URL = "asesoriadevisadosglobal.com/paola-samaniego.html"

OUT_PATH = os.path.join(os.path.dirname(__file__), "pdf-paola-samaniego-guia-uso.pdf")
