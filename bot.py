...
PRECIOS_PAQUETES = {
    "BASICO": 100, "ESENCIAL": 147, "PROFESIONAL": 197, "VIP": 265,
    "DIAGNOSTICO": 37, "MEXICO": 59, "RENOVACION": 59, "REVISION": 37,
    "URGENTE_BASICO": 140, "URGENTE_ESENCIAL": 187, "URGENTE_PROFESIONAL": 237, "URGENTE_VIP": 305,
}
        ...
        for entry in data.get("entry", []):
            for change in entry.get("changes", []):
                ...
                for msg in value.get("messages", []):
                    ...
                    # ── DETECCIÓN DE LEADS DE ANUNCIO ────────────────────────
                    # Detecta silenciosamente si el mensaje viene de un anuncio.
                    # El bot conversa con normalidad — solo registra el origen.
                    ...
                    if (viene_de_anuncio(text) and es_nuevo_lead(from_number, total_msgs)
                        ...
                        print(f"[LEAD] Lead de anuncio detectado: {from_number}")
